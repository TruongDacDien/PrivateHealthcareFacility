...
public class EnterEmailDialogController implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		resendBtn.setOnMouseClicked(event -> {
			...
			emailService2.send(EmailProperty.receive, "Mã khôi phục tài khoản", "" + randomNumber	);
		...
		emailService.send(EmailProperty.receive, "Mã khôi phục tài khoản", "" + EmailProperty.codeR	);
